...
UNITTEST_START_TESTCASE(fs_tests)
UNITTEST("test LK path normalize", test_path_normalize)
// UNITTEST("test LK stdio fs", test_stdio_fs)
UNITTEST_END_TESTCASE(fs_tests, "fs_tests", "lk fs tests")
